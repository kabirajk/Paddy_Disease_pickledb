...
# Save the image to a file
    ...
    # b="b0".join(["{:08b}".format(x) for x in binary_data])
    # b=bytes(binary_data, 'utf-8')
    # pred= Predictor(tf.keras.models.load_model('isPaddyorNot.h5'),tf.keras.models.load_model('ClassPredictor.h5'))
    # result = pred.Predict(f'image{count}.jpg')
...
def flush(modelName):
    global isPaddy
    global ClassPredictor
    if(modelName.lower()=='ispaddyornot' or modelName == "1"):
    ...
    if(modelName.lower=='classpredictor' or modelName == "2"):
